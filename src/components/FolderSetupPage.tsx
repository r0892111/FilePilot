          ...
          children: [
            {
              ...
              children: [
                ...
                { id: 'personal', name: 'Personal', path: '/Documents/Personal', parentId: 'documents' }
              ]
            },
            {
              id: 'work',
              ...
              children: [
                ...
                { id: 'meetings', name: 'Meetings', path: '/Work/Meetings', parentId: 'work' }
              ]
            },
            { id: 'archive', name: 'Archive', path: '/Archive', parentId: 'root' },
            { id: 'shared', name: 'Shared with me', path: '/Shared', parentId: 'root' }
          ]
        }
      ];
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl">
              ...
              {showCreateFolder && (
                <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                  <h3 className="font-semibold text-blue-900 mb-3">Create New Folder</h3>
                  <div className="flex items-center space-x-3">
                    <input
                      type="text"
                      value={newFolderName}
              ...
              <div className="bg-white rounded-2xl p-6 shadow-xl border-2 border-blue-200">
                ...
                <div className="bg-blue-50 rounded-lg p-4">
                  <div className="flex items-center mb-2">
                    ...
                    <span className="font-medium text-blue-900">{selectedFolderInfo.name}</span>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 h-fit">
              ...
              <div className="text-xs text-blue-200 mt-3">
                AI will automatically create and organize subfolders based on your document types
              </div>
            </div>
